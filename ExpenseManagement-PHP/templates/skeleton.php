...
<head>
    ...
    <title>Expense Ease</title>
    
</head>

<body class="overlay-scrollbar sidebar-expand">
    <!-- Navbar -->
    <div class="navbar" style="background-image: url('bg-im4.png');">
        <!-- nav-left -->
        <ul class="navbar-nav" style="background-color:dfcab8">
            <li class="nav-item">
                <a class='nav-link'>
        ...
        <!-- end nav left  -->
        <h1 class="navbar-text" style="color:white">Expense Ease</h1>
        <!-- nav right  -->
        <ul class="navbar-nav nav-right" style="background-color:dfcab8" >
            <!-- <li class="nav-item"
    ...
    <div class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="sidebar-nav-item" id="EC" onclick="openExpenseCategories()"> <!-- New Expense Categories Item -->
            <a href="expense_categories.php" class="sidebar-nav-link"> <!-- Link to Expense Categories Page -->
                <div>
                    <i class="fas fa-chart-pie"></i> <!-- Use an appropriate icon for categories -->
                </div>
                <span>
                    Expense Categories
                </span>
            ...
            <li class="sidebar-nav-item" id="AE" onclick="openAccidentalExpenses()">
                <a href="log_accidental_expense.php" class="sidebar-nav-link" >
                    <div>
                        <i class="fas fa-exclamation-circle"></i> <!-- Use an appropriate icon -->
                    </div>
                    <span>
                        Log Accidental Expenses
                    </span>
                </a>
            </li>
            <li class="sidebar-nav-item">
        <a href="view_accidental_expense.php" class="sidebar-nav-link" >
            <div>
                <i class="fas fa-eye"></i> <!-- You can change the icon as needed -->
            </div>
            <span>
                View Accidental Expenses
            </span>
        </a>
    </li>
        </ul>
